...
class Login extends CI_Controller {
    ...
    public function register() {
        ...
        $this->form_validation->set_rules('first_name', 'first_name', 'trim|required|min_length[2]|max_length[100]');
        $this->form_validation->set_rules('last_name', 'last_name', 'trim|required|min_length[2]|max_length[100]');
        ...
        $this->form_validation->set_rules('pincode', 'pincode', 'trim|required|max_length[100]');
        ...
        $this->form_validation->set_rules('mob_no', 'mob_no', 'trim|required|min_length[5]|max_length[100]');
