...
class Admin extends CI_Controller {
    ...
    public function get_magazines() {
        ...
        if(!empty($courses)) {
            ...
            foreach ($courses as $key => $row) {
                ...
                }elseif($row->course_type == 'general' || $row->course_type == 'magazine'){
    ...
    public function question_papers() {
        ...
        $page_data['status_wise_courses']    = $this->crud_model->get_status_wise_courses("",'question_paper');
    ...
    public function get_question_papers() {
        ...
        if(!empty($courses)) {
            ...
            foreach ($courses as $key => $row) {
                ...
                }elseif($row->course_type == 'general' || $row->course_type == 'magazine' || $row->course_type == 'question_paper'){
    ...
    public function sections($param1 = "", $param2 = "", $param3 = "") {
        ...
        $magazine = $this->db->get_where('course',['course_type'=>'magazine', 'id',$param3])->num_rows();

        if($magazine > 0){

            redirect(site_url('admin/magazine_form/magazine_edit/'.$param3));

        }else{

            redirect(site_url('admin/course_form/course_edit/'.$param3));
    ...
    public function lessons($course_id = "", $param1 = "", $param2 = "") {
        ...
        $magazine = $this->db->get_where('course',['course_type'=>'magazine', 'id'=>$course_id])->num_rows();
        ...
        if ($param1 == 'add') {
            ...
            if($magazine > 0){
                ...
                redirect(site_url('admin/magazine_form/magazine_edit/'.$course_id));
