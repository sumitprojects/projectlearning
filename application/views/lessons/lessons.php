...
if(isset($bundle_id) && $bundle_id > 0):
    ...
    $my_course_url = strtolower($this->session->userdata('role')) == 'user' ? site_url('my-courses') : 'javascript::';
...
<div class="container-fluid course_container">
    ...
    <div class="row" id = "lesson-container">
        ...
        <!-- Course sections and lesson selector sidebar starts-->
            ...
            <?php if($course_details['course_type'] == 'general' || $course_details['course_type'] == 'magazine' ): ?>
