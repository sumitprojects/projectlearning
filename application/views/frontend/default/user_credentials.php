                    ...
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                ...
                                <li class="active"><a href="<?php echo site_url('profile/user-credentials'); ?>"><?php echo site_phrase('account'); ?></a></li>
                                <li><a href="<?php echo site_url('profile/user-photo'); ?>"><?php echo site_phrase('photo'); ?></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="user-dashboard-content">
                        <div class="content-title-box">
                            <div class="title"><?php echo site_phrase('user_credentials'); ?></div>
