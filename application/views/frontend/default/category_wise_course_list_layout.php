    ...
    <li>
        ...
        <div class="course-box-2">
            ...
            <div class="course-image">
                ...
                <?php if($magazine):?>
                <a
                    href="<?php echo site_url('magazines/'.rawurlencode(slugify($course['title'])).'/'.$course['id']); ?>">
                    <?php elseif($questionpaper):?>
                    <a
                        href="<?php echo site_url('question-papers/'.rawurlencode(slugify($course['title'])).'/'.$course['id']); ?>">
                        <?php else:?>
                        <a
                            href="<?php echo site_url('courses/'.rawurlencode(slugify($course['title'])).'/'.$course['id']); ?>">
                            <?php endif; ?>
            ...
            <div class="course-details">
                ...
                <a href="<?php echo site_url(($magazine?'magazines/':'courses/').rawurlencode(slugify($course['title'])).'/'.$course['id']); ?>"
                ...
                <a href="<?php echo site_url('home/instructor_page/'.$instructor_details['id']) ?>"
                    ...
                    <span
                        class="instructor-name"><?php echo $instructor_details['first_name'].' '.$instructor_details['last_name']; ?></span>
                ...
                <div class="course-meta">
                    ...
                    <span class=""><i
                            class="fas fa-closed-captioning"></i><?php echo site_phrase($course['language']); ?></span>
