        ...
        <div class="row" id = "cart_items_details">
                                ...
                                <li>
                                    ...
                                    <div class="cart-course-wrapper">
                                        ...
                                        <div class="image">
                                            ...
                                            <a href="<?php echo site_url('courses/'.rawurlencode(slugify($course_details['title'])).'/'.$course_details['id']); ?>">
            ...
            <div class="col-lg-3">
                ...
                <div class="cart-sidebar">
                    ...
                    <button type="button" class="btn btn-sign-up btn-primary btn-block" onclick="handleCheckOut()"><?php echo site_phrase('checkout'); ?></button>
