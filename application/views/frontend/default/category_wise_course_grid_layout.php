   ...
   <div class="col-md-4 col-lg-4">
     ...
     <div class="course-box-wrap">
        ...
        <?php elseif($questionpaper):?>
            <a href="<?php echo site_url('question-papers/'.rawurlencode(slugify($course['title'])).'/'.$course['id']); ?>">
        <?php else:?>
            <a href="<?php echo site_url('courses/'.rawurlencode(slugify($course['title'])).'/'.$course['id']); ?>">
        <?php endif; ?>
