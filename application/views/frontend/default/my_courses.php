...
courses/
        ...
        <div class="row no-gutters" id = "my_courses_area">
            ...
            <?php foreach ($my_courses as $my_course):
                ...
                if(addon_status('course_subscription')){

                    $expiry_detail = $this->crud_model->check_course_enrol_expiry_for_course($my_course['course_id'],$course_details['user_id'])->row_array();
                            ...
                            <div class="course-box">
                                ...
                                <div class="" id = "course_info_view_<?php echo $my_course['course_id'];  ?>">
                                  ...
                                  <div class="course-details">
                                      ...
                                      <a href="<?php echo site_url('courses/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['course_id']); ?>"><h5 class="title"><?php echo ellipsis($course_details['title']); ?></h5></a>
                                  ...
                                  <div class="row" style="padding: 5px;">
                                      ...
                                      <div class="col-md-6 pt-2">
                                          ...
                                          <a href="<?php echo site_url('courses/'.rawurlencode(slugify($course_details['title'])).'/'.$my_course['course_id']); ?>" class="btn"><?php echo site_phrase('course_detail'); ?></a>
                                ...
                                <div class="course-details" style="display: none; padding-bottom: 10px;" id = "course_rating_view_<?php echo $course_details['id']; ?>">
                                  ...
                                  <?php
                    							...
                    							<form class="javascript::void(0)" action="" method="post">
