...
<section class="category-course-list-area">
    ...
    <div class="container">
        ...
        <div class="category-filter-box filter-box clearfix">
            ...
            <a href="javascript::" onclick="toggleLayout('grid')" style="float: right; font-size: 19px; margin-left: 5px;" class="text-dark"><i class="fas fa-th"></i></a>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="filter_type">
                                ...
                                <ul>
                                    ...
                                    if($magazine):
                                        $categories = $this->crud_model->get_categories('','magazines')->result_array();
                                    elseif($questionpaper):
                                        $categories = $this->crud_model->get_categories('','question-papers')->result_array();                                    
                                    else:
