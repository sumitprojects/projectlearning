...
<section class="d-sm-none d-md-block">
    ...
    <img src="<?php echo base_url(); ?>assets/frontend/default/img/web main.jpg" alt="" class="w-100 h-100 d-block">

</section>

<section class="d-sm-block d-md-none">

    <img src="<?php echo base_url(); ?>assets/frontend/default/img/mobile main.jpg" alt="" class="w-100 h-100 d-block">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 d-flex">
                ...
                <div class="home-fact-box mr-md-auto mr-auto">
                    ...
                    <i class="float-left"><img src="<?php echo base_url(); ?>assets/frontend/default/img/onlineCoursesFactBox.png"></i>
                    ...
                    <div class="text-box">
                        ...
                        <p class="text-capitalize">
                            ...
                            Digitally Comprehensive <b>Learning & Development</b> with Effective Training Management.
            ...
            <div class="col-lg-4 d-flex">
                ...
                <div class="home-fact-box mr-md-auto mr-auto">
                    ...
                    <i class="float-left"><img src="<?php echo base_url(); ?>assets/frontend/default/img/magazineFactBox.png"></i>
            ...
            <div class="col-lg-4 d-flex">
                ...
                <div class="home-fact-box mr-md-auto mr-auto">
                    ...
                    <i class="float-left"><img src="<?php echo base_url(); ?>assets/frontend/default/img/industryUpdatesFactBox.png"></i>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body-content">
                                    ...
                                    <a href="<?php echo site_url('magazines/'.rawurlencode(slugify($course['title'])).'/'.$course['id']); ?>"
                                        ...
                                        <p class="text-muted small-text">Published

                                            on:<?=date( 'd-m-Y', $course['date_added'])?></p>
...
<section class="d-sm-none d-md-block">
    ...
    <img src="<?php echo base_url(); ?>assets/frontend/default/img/web our philosophy.jpg" alt=""
...
<section class="d-sm-block d-md-none">
    ...
    <img src="<?php echo base_url(); ?>assets/frontend/default/img/mobile our philosophy.jpg" alt=""
    ...
    <div class="container-lg">
        ...
        <div class="col-sm-6 col-md-3 service-box py-3">
         <a href="<?=site_url('dictionary/english')?>">
            <img src="<?php echo base_url(); ?>assets/frontend/default/img/englishDictionary.png" class="img-fluid">
        ...
        <div class="col-sm-6 col-md-3 service-box py-3">
            ...
            <img src="<?php echo base_url(); ?>assets/frontend/default/img/hospitalityKeywords.png" class="img-fluid">
        ...
        <div class="col-sm-6 col-md-3 service-box py-3">
            ...
            <img src="<?php echo base_url(); ?>assets/frontend/default/img/frenchDictionary.png" class="img-fluid">
        ...
        <div class="col-sm-6 col-md-3 service-box py-3">
            ...
            <img src="<?php echo base_url(); ?>assets/frontend/default/img/questionPapers.png" class="img-fluid">
        ...
        <div>
            ...
            <div class="box">
                ...
                <figure class="image">
                    ...
                    <img src="<?php echo $this->user_model->get_user_image_url($review('user_id')); ?>" alt="user-image"

                        height="42" class="img-fluid rounded-circle shadow-sm">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <h1 class="text-black text-center font-weight-bold py-3 text-uppercase">
                    ...
                    <?php echo site_phrase('all_coruses'); ?>
                ...
                <div class="filters-button-group py-4">
                    ...
                    <a href="<?php echo base_url(); ?>/faq" class="btn btn-outline-dark text-uppercase"><?php echo site_phrase('explore_FAQ'); ?></a>
    ...
    <div class="container-lg">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <p class="py-4"><a href="https://community.hospitalityconnaisseur.com/category/podcast/" target="_blank" class="btn btn-outline-dark"><?php echo site_phrase('show_all'); ?></a></p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-body-content">
                                    ...
                                    <a href="<?=$news->link?>" target="_blank" rel="noopener noreferrer">
                                        ...
                                        <p class="text-muted small-text">Published on:

                                            <?=date( 'd-m-Y', strtotime($news->pubDate))?></p>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <p class="text-white">
                        ...
                        Simply Enter Your Email Address To Get Exclusive Access To our weekly Newsletter. We Provide The
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <form class="form-row" method="post" action="<?=site_url('home/newsletter')?>">
                        ...
                        <div class="col my-4">
                            ...
                            <small class="form-text text-white">We'll never share your email with anyone else. <a
                                    ...
                                    href="<?=site_url('home/privacy_policy')?>">T&C* apply</a></small>
    ...
    <div class="container-lg">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <a href="https://community.hospitalityconnaisseur.com/category/hotel-management/" target="_blank" class="btn btn-outline-dark"><?php echo site_phrase('hotels'); ?></a>

                <a href="https://community.hospitalityconnaisseur.com/category/aviation-management/" target="_blank" class="btn btn-outline-dark"><?php echo site_phrase('aviation'); ?></a>

                <a href="https://community.hospitalityconnaisseur.com/category/tourism-management/" target="_blank" class="btn btn-outline-dark"><?php echo site_phrase('tourism'); ?></a>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <p class="py-4">
                    ...
                    <a href="https://community.hospitalityconnaisseur.com/category/news/" target="_blank" class="btn btn-outline-light"><?php echo site_phrase('show_all'); ?></a>
        ...
        <div class="box">
            ...
            <div class="test-component">
                ...
                <article class="test-content">
                    ...
                    <img class="img-fluid" src="<?php echo base_url(); ?>/assets/frontend/default/img/UDYAM.jpg">
...
<section class="d-sm-none d-md-block">
    ...
    <a href="<?=site_url('home/advertise_with_us')?>" target="_blank" rel="noopener noreferrer">

        <img src="<?php echo base_url(); ?>assets/frontend/default/img/web footer.jpg" alt="" class="w-100 h-100 d-block">
...
<a href="<?=site_url('home/advertise_with_us')?>" target="_blank" rel="noopener noreferrer">    
    ...
    <img src="<?php echo base_url(); ?>assets/frontend/default/img/mobile footer.jpg" alt=""
