...
<img src="<?php echo base_url(); ?>assets/frontend/default/img/web about us.jpg" alt="" class="w-100 h-100 d-block">
</section>
<section class="d-sm-block d-md-none">
<img src="<?php echo base_url(); ?>assets/frontend/default/img/mobile about us.jpg" alt="" class="w-100 h-100 d-block">
</section>


<?php echo get_frontend_settings('about_us'); ?>
<section class="py-5 bg-gradient">
    <h1 class="text-dark text-center py-4">Certifications & Recognitions</h1>
