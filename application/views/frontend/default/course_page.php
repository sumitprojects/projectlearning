...
$magazine = ($course_details['course_type'] == 'magazine'); 

$questionpaper = ($course_details['course_type'] == 'question-paper'); 
    ...
    <div class="row align-items-end">
      ...
      <div class="col-lg-8">
        ...
        <div class="course-header-wrap">
          ...
          <span class="enrolled-num d-none">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <?php if($course_details['course_type'] == 'general' || $course_details['course_type'] == 'magazine' || $course_details['course_type'] == 'question_paper' ): ?>
              ...
              <div class="float-right">
                <span class="total-lectures">
                  ...
                  <?php elseif($questionpaper):?>
                    <?php echo $this->crud_model->get_lessons('course', $course_details['id'])->num_rows().' '.site_phrase('questionpaper'); ?>
                  <?php else:?>
                ...
                <div class="lecture-group-title clearfix" data-toggle="collapse" data-target="#collapse<?php echo $section['id']; ?>" aria-expanded="<?php if($counter == 0) echo 'true'; else echo 'false' ; ?>">
                  ...
                  <div class="float-right">
                    ...
                    <span class="total-lectures">
                      ...
                      <?php echo $this->crud_model->get_lessons('section', $section['id'])->num_rows().' '.site_phrase($course_details['course_type'] == 'general'?'lessons':$course_details['course_type']); ?>
    ...
    <div class="compare-box view-more-parent expanded">
      ...
      <div class="compare-title"><?php echo site_phrase('other_related_'.($course_details['course_type']== 'general'?'courses':$course_details['course_type'])); ?></div>
          ...
          <div class="course-comparism-item-container this-course">
            ...
            <div class="course-comparism-item clearfix">
              ...
              <div class="item-image float-left  mt-4 mt-md-0">
                ...
                <a href="<?php echo site_url('courses/'.slugify($other_realted_course['title']).'/'.$other_realted_course['id']); ?>"><img src="<?php $this->crud_model->get_course_thumbnail_url($other_realted_course['id']); ?>" alt="" class="img-fluid"></a>
      ...
      <div class="col-lg-4">
        ...
        <div class="about-instructor-image">
          ...
          <ul>
            ...
            <li class="d-none"><i class="fas fa-user"></i><b>
      ...
      <div class="col-lg-8">
        ...
        <div class="about-instructor-details view-more-parent expanded">
          ...
          <div class="instructor-name">
            ...
            <a href="<?php echo site_url('home/instructor_page/'.$course_details['user_id']); ?>" class="text-dark"><?php echo $instructor_details['first_name'].' '.$instructor_details['last_name']; ?></a>
