        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i>
                    ...
                    <?php echo get_phrase('question_papers'); ?>

                    <a href="<?php echo site_url('admin/question_paper_form/add_question_paper'); ?>"

                        class="btn btn-outline-primary btn-rounded alignToTitle"><i

                            class="mdi mdi-plus"></i><?php echo get_phrase('add_new_question_paper'); ?></a>
                </h4>
                        ...
                        <a href="<?php echo site_url('admin/question_papers'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('active_question_papers'); ?></p>
                        ...
                        <a href="<?php echo site_url('admin/question_papers'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('pending_question_papers'); ?>
                        ...
                        <a href="<?php echo site_url('admin/question_papers'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('free','','question_paper')->num_rows(); ?></span>
                        ...
                        <a href="<?php echo site_url('admin/question_papers'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('paid','','question_paper')->num_rows(); ?></span>
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('admin/question_papers'); ?>"
                ...
                <div class="table-responsive-sm mt-4">
                    ...
                    <table id="question-paper-datatable-server-side" class="table table-striped dt-responsive nowrap"
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th><?php echo get_phrase('purchased'); ?></th>
