    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('question_paper_manager'); ?>

                    <a href="<?php echo site_url('question-papers/'.slugify($course_details['title']).'/'.$course_id); ?>"
                ...
                <div class="row w-100">
                    ...
                    <div class="col-xl-12">
                        ...
                        <form class="required-form"
                            ...
                            action="<?php echo site_url('admin/question_paper_actions/edit/'.$course_id); ?>" method="post"
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <label class="col-md-2 col-form-label"
                                                        ...
                                                        for="course_title"><?php echo get_phrase('question_paper_title'); ?><span
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <label class="col-md-2 col-form-label"
                                                        ...
                                                        for="course_expiry"><?php echo get_phrase('question_paper_expiry'); ?><span

                                                            class="required">*</span></label>

                                                    <div class="col-md-10">

                                                        <input name="course_expiry" id="question_paper_expiry" type="number"
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <label class="col-md-2 col-form-label"
                                                        ...
                                                        for="course_overview_url"><?php echo get_phrase('question_paper_overview_url'); ?></label>
