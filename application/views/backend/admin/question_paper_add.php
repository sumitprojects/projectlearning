        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i>
                    ...
                    <?php echo get_phrase('add_new_question_paper'); ?></h4>
            ...
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('question_paper_adding_form'); ?>
                    ...
                    <a href="<?php echo site_url('admin/question_papers'); ?>"
                        ...
                        <?php echo get_phrase('back_to_question_paper_list'); ?></a>
                ...
                <div class="row w-100">
                    ...
                    <div class="col-xl-12">
                        ...
                        <form class="required-form" action="<?php echo site_url('admin/question_paper_actions/add'); ?>"
                                    ...
                                    <div class="tab-pane" id="basic">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <input type="hidden" name="course_type" value="question_paper">

                                                <div class="form-group row mb-3">

                                                    <label class="col-md-2 col-form-label"

                                                        for="question_paper_title"><?php echo get_phrase('question_paper_title'); ?>

                                                        <span class="required">*</span> </label>

                                                    <div class="col-md-10">

                                                        <input type="text" class="form-control" id="question_paper_title"

                                                            name="title"

                                                            placeholder="<?php echo get_phrase('enter_question_paper_title'); ?>"
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <label class="col-md-2 col-form-label"
                                                        ...
                                                        for="course_expiry"><?php echo get_phrase('course_expiry'); ?><span
                                                    ...
                                                    <div class="offset-md-2 col-md-10">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label"
                                                                ...
                                                                for="is_top_course"><?php echo get_phrase('check_if_this_question_paper_is_top_question_paper'); ?></label>
                                                    ...
                                                    <div class="offset-md-2 col-md-10">
                                                        ...
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            <label class="custom-control-label"
                                                                ...
                                                                for="is_free_course"><?php echo get_phrase('check_if_this_is_a_free_question_paper'); ?></label>
                                                ...
                                                <div class="paid-course-stuffs">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <label class="col-md-2 col-form-label"
                                                            ...
                                                            for="price"><?php echo get_phrase('question_paper_price').' ('.currency_code_and_symbol().')'; ?></label>
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <input type="number" class="form-control" id="price"
                                                                ...
                                                                placeholder="<?php echo get_phrase('enter_question_paper_price'); ?>"
                                                        ...
                                                        <div class="offset-md-2 col-md-10">
                                                            ...
                                                            <div class="custom-control custom-checkbox">
                                                                ...
                                                                <label class="custom-control-label"
                                                                    ...
                                                                    for="discount_flag"><?php echo get_phrase('check_if_this_question_paper_has_discount'); ?></label>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <small
                                                                ...
                                                                class="text-muted"><?php echo get_phrase('this_question_paper_has'); ?>
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <label class="col-md-2 col-form-label"
                                                        ...
                                                        for="question_paper_overview_provider"><?php echo get_phrase('question_paper_overview_provider'); ?></label>
