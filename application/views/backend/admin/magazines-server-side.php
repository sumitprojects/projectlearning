        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i>
                    ...
                    <?php echo get_phrase('magazines'); ?>

                    <a href="<?php echo site_url('admin/magazine_form/add_magazine'); ?>"

                        class="btn btn-outline-primary btn-rounded alignToTitle"><i

                            class="mdi mdi-plus"></i><?php echo get_phrase('add_new_magazines'); ?></a>
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('active_magazines'); ?></p>
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('pending_magazines'); ?>
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('free','','magazine')->num_rows(); ?></span>

                                    </h3>

                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('free_magazines'); ?></p>
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('paid','','magazine')->num_rows(); ?></span>

                                    </h3>

                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('paid_magazines'); ?></p>
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-3 header-title"><?php echo get_phrase('magazines_list'); ?></h4>

                <form class="row justify-content-center" action="<?php echo site_url('admin/magazines'); ?>"
                ...
                <div class="table-responsive-sm mt-4">
                    ...
                    <table id="magazine-datatable-server-side" class="table table-striped dt-responsive nowrap"
