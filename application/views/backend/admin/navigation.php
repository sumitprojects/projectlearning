    ...
    <ul class="metismenu side-nav side-nav-light">
        ...
        <li class="side-nav-item">
            ...
            <a href="<?php echo site_url('admin/magazines'); ?>"
                class="side-nav-link <?php if ($page_name == 'magazines' || $page_name == 'magazine_add' || $page_name == 'magazine_edit')echo 'active';?>">

                <i class="dripicons-archive"></i>

                <span><?php echo get_phrase('magazines'); ?></span>
        ...
        <li class="side-nav-item">
            ...
            <a href="<?php echo site_url('admin/question_papers'); ?>"
                class="side-nav-link <?php if ($page_name == 'question_papers' || $page_name == 'question_paper_add' || $page_name == 'question_paper_edit')echo 'active';?>">

                <i class="dripicons-archive"></i>

                <span><?php echo get_phrase('question_papers'); ?></span>
        ...
        <li class="side-nav-item">
            ...
            <a href="<?php echo site_url('admin/manage_newsletter'); ?>"
                class="side-nav-link <?php if ($page_name == 'manage_newsletter')echo 'active';?>">

                <i class="dripicons-message"></i>

                <span><?php echo get_phrase('manage_newsletter'); ?></span>
        ...
        <li class="side-nav-item">
            ...
            <a href="<?php echo site_url('admin/manage_faq'); ?>"
                class="side-nav-link <?php if ($page_name == 'manage_faq')echo 'active';?>">

                <i class="dripicons-message"></i>

                <span><?php echo get_phrase('manage_faq'); ?></span>
        ...
        <li class="side-nav-item">
            ...
            <a href="<?php echo site_url('admin/manage_advertiser'); ?>"
                class="side-nav-link <?php if ($page_name == 'manage_advertiser')echo 'active';?>">

                <i class="dripicons-message"></i>

                <span><?php echo get_phrase('manage_advertiser'); ?></span>
        ...
        <li class="side-nav-item">
            ...
            <a href="<?php echo site_url('admin/reputed_advertisers'); ?>"
                class="side-nav-link <?php if ($page_name == 'reputed_advertisers')echo 'active';?>">

                <i class="dripicons-message"></i>

                <span><?php echo get_phrase('reputed_advertisers'); ?></span>
        ...
        <li class="side-nav-item">
            ...
            <a href="<?php echo site_url('admin/manage_jobs'); ?>"
                class="side-nav-link <?php if ($page_name == 'manage_job')echo 'active';?>">

                <i class="dripicons-message"></i>

                <span><?php echo get_phrase('manage_job'); ?></span>
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/manage_dictionary'); ?>"
                ...
                <span><?php echo get_phrase('manage_dictionary'); ?></span>
        ...
        <li
            ...
            <ul class="side-nav-second-level" aria-expanded="false">
                ...
                <li class="<?php if($page_name == 'course_subscription_settings') echo 'active'; ?>">

                    <a
                        href="<?php echo site_url('addons/course_subscription/settings'); ?>"><?php echo get_phrase('course_subscription_settings'); ?></a>
