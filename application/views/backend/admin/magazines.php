    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('magazines'); ?>

                    <a href="<?php echo site_url('admin/magazine_form/add_magazine'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_magazine'); ?></a>
            ...
            <div class="card-body p-0">
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('active_magazine'); ?></p>
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('pending_magazine'); ?></p>
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('free','','magazine')->num_rows(); ?></span></h3>

                                    <p class="text-muted font-15 mb-0"><?php echo get_phrase('free_magazine'); ?></p>
                        ...
                        <a href="<?php echo site_url('admin/magazines'); ?>" class="text-secondary">
                            ...
                            <div class="card shadow-none m-0 border-left">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <h3><span><?php echo $this->crud_model->get_free_and_paid_courses('paid','','magazine')->num_rows(); ?></span></h3>
    ...
    <div class="col-xl-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <h4 class="mb-3 header-title"><?php echo get_phrase('magazine_list'); ?></h4>

                <form class="row justify-content-center" action="<?php echo site_url('admin/magazines'); ?>" method="get">
                    ...
                    <table id="course-datatable" class="table table-striped dt-responsive nowrap" width="100%" data-page-length='25'>
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th><?php echo get_phrase('magazine_and_section'); ?></th>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <strong><a href="<?php echo site_url('admin/magazine_form/magazine_edit/'.$course['id']); ?>"><?php echo ellipsis($course['title']); ?></a></strong><br>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($course['course_type'] == 'magazine'): ?>

                                            <small class="text-muted"><?php echo '<b>'.get_phrase('total_section').'</b>: '.$sections->num_rows(); ?></small><br>

                                            <small class="text-muted"><?php echo '<b>'.get_phrase('total_magazines').'</b>: '.$lessons->num_rows(); ?></small>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropright dropright">
                                          ...
                                          <ul class="dropdown-menu">
                                              ...
                                              <li><a class="dropdown-item" href="<?php echo site_url('home/magazine/'.slugify($course['title']).'/'.$course['id']); ?>" target="_blank"><?php echo get_phrase('view_course_on_frontend');?></a></li>

                                              <li><a class="dropdown-item" href="<?php echo site_url('admin/magazine_form/magazine_edit/'.$course['id']); ?>"><?php echo get_phrase('edit_this_magazine');?></a></li>

                                              <?php if($course['course_type'] != 'scorm'): ?>

                                                  <li><a class="dropdown-item" href="<?php echo site_url('admin/magazine_form/magazine_edit/'.$course['id']); ?>"><?php echo get_phrase('section_and_lesson');?></a></li>
