<div class="row">
    <div class="col-md-12">
        <form class="ajaxForm" action="<?= site_url('admin/course_actions/add_shortcut'); ?>">
            ...
            <div class="form-group">
                <label for="course_expiry"><?php echo get_phrase('course_expiry'); ?><span
                        class="required">*</span></label>
                <input name="course_expiry" id="course_expiry" type="number" min="0" value="30" class="form-control"
                    required />
            </div>
            <?php endif; ?>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" data-toggle="select2" name="language_made_in"
                    id="language_made_in">
            ...
            <div class="form-group">
                <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" name="is_free_course" id="is_free_course_s"
                        value="1" onclick="togglePriceFields(this.id)">
                    <label class="custom-control-label"
                        for="is_free_course_s"><?php echo get_phrase('check_if_this_is_a_free_course'); ?></label>
                </div>
            </div>
            ...
            <div class="paid-course-stuffs">
                <div class="form-group">
                    <label
                        for="price_s"><?php echo get_phrase('course_price').' ('.currency_code_and_symbol().')'; ?></label>
                    <input type="number" class="form-control" id="price_s" name="price"
                        placeholder="<?php echo get_phrase('enter_course_course_price'); ?>" min="0">
                </div>

                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" name="discount_flag" id="discount_flag_s"
                            value="1">
                        <label class="custom-control-label"
                            for="discount_flag_s"><?php echo get_phrase('check_if_this_course_has_discount'); ?></label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <small class="text-muted"><?php echo get_phrase('this_course_has'); ?> <span
                            id="discounted_percentage_s" class="text-danger">0%</span>
