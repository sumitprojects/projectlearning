...
class Email_model extends CI_Model {
	...
	public function contact_form_notify($data = ""){
		$student_msg = "<h2>Feedback from Contact Form</h2>";
		$student_msg .= "<p><b>".$data['first_name']." ".$data['last_name']."</b> provided a feedback from your contact form.</p>";
		$student_msg .= "<hr style='opacity: .4;'>";
		$student_msg .= "<p>Name: <b>".$data['first_name']." ".$data['last_name']."</b></p>";
		$student_msg .= "<p>Email: <b>".$instructor_details['email']."</b></p>";

		$email_data['subject'] = 'Feedback from Contact Form';
		$email_data['from'] = get_settings('system_email');
		$email_data['to'] = $data['email'];
		$email_data['to_name'] = $data['first_name'].' '.$data['last_name'];
