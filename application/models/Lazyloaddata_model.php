...
class Lazyloaddata_model extends CI_Model {
  ...
  function courses($limit, $start, $col, $dir, $filter_data, $type = 'general')
  ...
  function course_search($limit, $start, $search, $col, $dir, $filter_data,$type = 'general')
  ...
  function count_all_courses($filter_data = array(),$type = 'general') {
